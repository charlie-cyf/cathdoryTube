...
insert into ItemsInDeal (itemId, dealName, percentage) values (‘078’, 'Christmas Sale', ’0.5’);
insert into ItemsInDeal (itemId, dealName, percentage) values (‘156’, 'Spring Sale', ‘0.2’);
insert into ItemsInDeal (itemId, dealName, percentage) values (‘245’, 'Spring Sale', ‘0.25’);
insert into ItemsInDeal (itemId, dealName, percentage) values (‘001’, 'Summer Sale', ‘0.10’);
insert into ItemsInDeal (itemId, dealName, percentage) values (‘412’, 'Summer Sale', ‘0.30’);
...
insert into Purchase (receiptNumber, purchaseDate, purchaseTime, TotalPrice, clerkId, BranchNumber) values (3428, 23-12, 6:01, 65.73, 1441, 5);
...
insert into MemberPurchase (receiptNumber, purchaseDate, purchaseTime, totalPrice, clerkId) values (3407, 15-02, 6:15, 17.55, 1252);
insert into MemberPurchase (receiptNumber, purchaseDate, purchaseTime, totalPrice, clerkId) values (3300, 16-01, 24:27, 67.64, 1144);
insert into MemberPurchase (receiptNumber, purchaseDate, purchaseTime, totalPrice, clerkId) values (3181, 12-03, 14:00, 16.37, 1093);
insert into MemberPurchase (receiptNumber, purchaseDate, purchaseTime, totalPrice, clerkId) values (3226, 02-05, 1:15, 32.02, 1441);
insert into MemberPurchase (receiptNumber, purchaseDate, purchaseTime, totalPrice, clerkId) values (3441, 17-06, 17:08, 24.72, 1456);
